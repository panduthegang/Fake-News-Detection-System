...
const calculateContentStatistics = async (text: string): Promise<ContentStatistics> => {
  ...
  const sentences = text.split(/[.!?।|॥]+/).filter(Boolean); // Added Gujarati sentence endings
...
["keyword1", "keyword2", "keyword3", "keyword4", "keyword5"]`;
  ...
  const emotionalWords = {
    positive: i18n.language === 'gu' ? 
      ['સારું', 'શ્રેષ્ઠ', 'ઉત્તમ', 'અદ્ભુત', 'શાનદાર', 'સકારાત્મક', 'સફળતા'] :
      i18n.language === 'hi' ?
      ['अच्छा', 'बेहतर', 'उत्कृष्ट', 'अद्भुत', 'शानदार', 'सकारात्मक', 'सफलता'] :
      ['good', 'great', 'excellent', 'amazing', 'wonderful', 'positive', 'success'],
    negative: i18n.language === 'gu' ?
      ['ખરાબ', 'નબળું', 'ભયાનક', 'નિરાશાજનક', 'નકારાત્મક', 'નિષ્ફળતા'] :
      i18n.language === 'hi' ?
      ['बुरा', 'खराब', 'भयानक', 'घटिया', 'नकारात्मक', 'असफलता'] :
      ['bad', 'terrible', 'awful', 'horrible', 'negative', 'failure'],
    urgent: i18n.language === 'gu' ?
      ['તાત્કાલિક', 'તાકીદનું', 'જરૂરી', 'આવશ્યક', 'મહત્વપૂર્ણ'] :
      i18n.language === 'hi' ?
      ['तत्काल', 'जरूरी', 'आपातकालीन', 'आवश्यक', 'महत्वपूर्ण'] :
      ['urgent', 'immediate', 'emergency', 'critical', 'vital']
  };
...
// Fallback keyword extraction function with language support
