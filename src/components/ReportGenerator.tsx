...
import { FileDown, Share2, Badge } from 'lucide-react';
...
export const ReportGenerator: React.FC<ReportGeneratorProps> = ({ result, text }) => {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      // PDF Header
      // Instead of using SVG, we'll draw a simple logo
  ...
  const generateVerificationBadge = async () => {
    ...
    canvas.width = 400;
    canvas.height = 400;
    ctx.scale(2, 2); // Scale for retina display
